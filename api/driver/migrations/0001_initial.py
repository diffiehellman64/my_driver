# Generated by Django 3.1 on 2024-03-13 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passengers', models.ManyToManyField(related_name='passenger_drives', to=settings.AUTH_USER_MODEL)),
                ('vehicle', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='drives', to='driver.vehicle')),
            ],
        ),
    ]
